...
session_state = SessionState.get(
    attendance_data={'date': '', 'name': 'unknown', 't_focused': 0, 't_distracted': 0,
                     't_total': 0, 'Attendance': 'P', 'Quality': 'NA'})
...
def app():
    ...
    if atn and run:
        ...
        # Load images.
        image_1 = face_recognition.load_image_file("../Media/1_dhaval.jpeg")
        image_1_face_encoding = face_recognition.face_encodings(image_1)[0]

        image_2 = face_recognition.load_image_file("../Media/2_dhruvin.jpeg")
        image_2_face_encoding = face_recognition.face_encodings(image_2)[0]

        image_3 = face_recognition.load_image_file("../Media/3_durvang.jpeg")
        image_3_face_encoding = face_recognition.face_encodings(image_3)[0]

        image_4 = face_recognition.load_image_file("../Media/4_dwayne.jpeg")
        image_4_face_encoding = face_recognition.face_encodings(image_4)[0]

        image_5 = face_recognition.load_image_file("../Media/5_harsh.jpg")
    ...
    while run:
        ...
        if ret:
            ...
            for (x, y, w, h) in faces_detected:
                ...
                session_state.attendance_data['t_total'] = session_state.attendance_data['t_distracted'] + \
                    session_state.attendance_data['t_focused']
